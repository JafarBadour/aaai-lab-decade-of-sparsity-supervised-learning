...
\textbf{Insane 95\% parameter reduction!} Can we achieve this with minimal performance loss?
\end{alertblock}
\end{frame}
...
\begin{itemize}
    \item \textbf{Insane 95\% parameter reduction} (1.3M $\rightarrow$ 65K)
...
\begin{enumerate}
    \item \textbf{Sparse training works!} Insane 95\% parameter reduction with only 2.27\% accuracy drop
...
\begin{itemize}
    ...
    \item But requires truly sparse implementations to realize full benefits
\end{itemize}
\end{alertblock}
...
\textbullet\ \textbf{Insane 95\% parameter reduction}\\
